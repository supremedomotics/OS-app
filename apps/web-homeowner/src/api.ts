...
export async function approveKnxDevice(input: { device: KnxUnifiedDevice; name: string; roomId?: string; roomNameHint?: string; plans: KnxBindingPlan[]; force?: boolean }): Promise<KnxApprovalResult> {
