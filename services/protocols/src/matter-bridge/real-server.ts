...
export interface RealMatterBridgeServerOptions {
  /** Directory `@matter/main` persists fabric/commissioning/node state under — the boundary
   * documented in §12 (Persistence). SupremeOS backup/restore must include this directory
   * verbatim; it is intentionally NOT re-implemented as a second, parallel fabric store. */
  storagePath: string;
