...
Uses:
  ...
  Media Engine              (full)
  Artwork Engine            (full — static album-art URL proxy)
  ...
  Capability Discovery      (Partial — SSDP/UPnP + AppCommand enrichment, no cross-protocol dedup)
```
